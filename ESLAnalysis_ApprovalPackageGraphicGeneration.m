...
% Print the DPA Coverage Results: Percentage of Part-2 DPA Grid Points
% covered with Reliability 0.5
Part2CoveragePercentage50 = sum(gridPointTally50_temp(DPA_gridInfo_Temp(:,4)==0)==1)/sum(DPA_gridInfo_Temp(:,4)==0)*100;
TxtBos_str_init_Part2CovPercentage = ['Grid Point Coverage (beyond 75Km, Rel >= 0.5): ', num2str(Part2CoveragePercentage50), '% of the DPA'];
